    ...
    <footer className="max-container">
      ...
      flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          text-white-400 sm:max-w-sm">
            Get To Playing With Fenders Extensive Range. Find
            Your Perfect Music Gear Either In Store Or Online.
          </p>
          <div className="flex items-center gap-5 mt-8">
            {socialMedia.map((icon) => (
              <div className="flex justify-center items-center
              w-12 h-12 bg-white rounded-full cursor-pointer" key={icon.alt}>
            ...
            <div key={section.title}>
              ...
              <ul>
                {section.links.map((link) => (
                  ...
                  leading-normal hover:text-cherry-red cursor-pointer" key={link.name}>
                    <a href="">{link.name}</a>
                  </li>
                ))}
              </ul>
      ...
      max-sm:items-center">
        ...
        cursor-pointer">
          ...
          <p>Copyright 2024. Fender Musical Instruments Corporation. All Rights Reserved.</p>
        </div>
